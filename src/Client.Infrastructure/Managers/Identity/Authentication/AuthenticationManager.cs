...
using DynaCore.Client.Infrastructure.Routes;
using DynaCore.Shared.Constants.Storage;
using Microsoft.Extensions.Localization;

namespace DynaCore.Client.Infrastructure.Managers.Identity.Authentication
{
