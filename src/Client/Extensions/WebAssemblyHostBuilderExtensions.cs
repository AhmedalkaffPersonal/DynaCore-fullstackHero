...
using DynaCore.Client.Infrastructure.Authentication;
using DynaCore.Client.Infrastructure.Managers;
using DynaCore.Client.Infrastructure.Managers.Preferences;
...
using DynaCore.Client.Infrastructure.Managers.ExtendedAttribute;
using DynaCore.Domain.Entities.ExtendedAttributes;
using DynaCore.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace DynaCore.Client.Extensions
{
