...
{
    public partial class AddEditVendorModal
    {
        [Inject] private IVendorManager VendorManager { get; set; }

        [Parameter] public AddEditVendorCommand AddEditVendorModel { get; set; } = new();
        ...
        {
            var response = await VendorManager.SaveAsync(AddEditVendorModel);
