...
using DynaCore.Infrastructure.Extensions;
using DynaCore.Server.Extensions;
using DynaCore.Server.Middlewares;
using Hangfire;
...
using System.IO;
using DynaCore.Server.Filters;
using DynaCore.Server.Managers.Preferences;
using Microsoft.Extensions.Localization;

namespace DynaCore.Server
{
