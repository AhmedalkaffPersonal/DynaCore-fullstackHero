namespace DynaCore.Shared.Constants.Application
{
    public static class ApplicationConstants
    {
        ...
        {
            public const string GetAllVendorsCacheKey = "all-vendorss";
            public const string GetAllContactPersonsCacheKey = "all-contactPersons";
