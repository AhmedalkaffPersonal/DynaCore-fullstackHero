...
namespace DynaCore.Shared.Constants.Permission
{
    public static class Permissions
    {
        ...
        {
            public const string View = "Permissions.ContactPersons.View";
            public const string Create = "Permissions.ContactPersons.Create";
            public const string Edit = "Permissions.ContactPersons.Edit";
            public const string Delete = "Permissions.ContactPersons.Delete";
            public const string Export = "Permissions.ContactPersons.Export";
            public const string Search = "Permissions.ContactPersons.Search";
        }
